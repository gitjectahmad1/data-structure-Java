...
public class Questions {
	//Question-1: remove duplicate nodes in list 
	...
	LinkedList partitiion(LinkedList ll, int x) {
	...
	void addSameNode(LinkedList llA, LinkedList llB, int nodeValue) {
		...
		llB.tail = newNode;
		// Time Complexity O(A+B)[A, B size of list1 and list2] Space Complexity O(1)
	}
}
